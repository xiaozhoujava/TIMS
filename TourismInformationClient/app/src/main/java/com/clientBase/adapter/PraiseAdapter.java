...
public class PraiseAdapter extends BaseAdapter {
    ...
    private List<PraiseModel> list_result;
    private int posIndex;
    private Context mContext;

    public PraiseAdapter(Context context, List<PraiseModel> list_result) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.titleInfor.setText(list_result.get(position).getPraiseUserName()+"点赞了攻略");
        holder.contentInfor.setText("攻略是："+list_result.get(position).getPraiseMessageName());
