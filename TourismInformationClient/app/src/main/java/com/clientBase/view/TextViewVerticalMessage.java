...
public class TextViewVerticalMessage extends View {
    ...
    public TextViewVerticalMessage(Context context){
        super(context);
        initPaint();
        initFontInfo();
    }

    public TextViewVerticalMessage(Context context,AttributeSet attrs){
        super(context, attrs);
        this.attrs=attrs;
        initPaint();
        initFontInfo();
