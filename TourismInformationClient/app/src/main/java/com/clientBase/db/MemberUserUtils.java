...
public class MemberUserUtils {
	...
	public static String getCityCode(Context context) {
		try {
			...
			return preferences.getString("CityCode", "1");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "";
	...
	public static void setCityCode(Context context, String uid) {
		SharedPreferences preferences = context.getSharedPreferences("MemberManager", 0);
		preferences.edit().putString("CityCode", uid).commit();
	}
	...
	public static String getCityName(Context context) {
		try {
			SharedPreferences preferences = context.getSharedPreferences("MemberManager", 0);
			return preferences.getString("CityName", "西安市");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "";
	...
	public static void setCityName(Context context, String uid) {
		SharedPreferences preferences = context.getSharedPreferences("MemberManager", 0);
		preferences.edit().putString("CityName", uid).commit();
	}
	...
	public static void setTag(Context context, String uid) {
		SharedPreferences preferences = context.getSharedPreferences("MemberManager", 0);
		preferences.edit().putString("Tag", uid).commit();
	}
