...
public class InforMainFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
	    	...
	    	View rootView = inflater.inflate(R.layout.fragment_im_bbs, null);
	    	/**
		* 初始化三个Fragment  并且填充到ViewPager
		*/
		vPager = (ViewPager) rootView.findViewById(R.id.viewpager_home);
		FriendFragment imMessageFragment=new FriendFragment();
		CourseFragment imFriendFragment=new CourseFragment();
