...
import com.client.R;
import com.clientBase.adapter.FragmentAdapter;

import java.util.ArrayList;
import java.util.List;


public class MainSceneryFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
	    	...
	    	View rootView = inflater.inflate(R.layout.fragment_im_scenery, null);
	    	/**
		* 初始化三个Fragment  并且填充到ViewPager
		*/
		vPager = (ViewPager) rootView.findViewById(R.id.viewpager_home);
		RankFragment imFriendFragment=new RankFragment();
		SceneryFragment imMessageFragment=new SceneryFragment();
		list.add(imFriendFragment);
