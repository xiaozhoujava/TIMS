...
import com.client.R;
import com.clientBase.adapter.MyTopicAdapter;
...
public class MyTopicActivity extends BaseActivity {
	...
	private List<TopicModel> list_result = new ArrayList<TopicModel>();
	...
	private void MessageAction(boolean isShow) {
		...
		params.put("action_flag", "listMyMessageTopic");
	...
	MyTopicAdapter orderListAdapter;
	@Override
			...
			case Consts.actionId.resultFlag:
				if (null != entry.getData() && !TextUtils.isEmpty(entry.getData())) {
					...
					if (null != jsonMsg && !TextUtils.isEmpty(jsonMsg)) {
						list_result = mGson.fromJson(entry.getData(), new TypeToken<List<TopicModel>>() {
						}.getType());
						orderListAdapter = new MyTopicAdapter(MyTopicActivity.this, list_result);
