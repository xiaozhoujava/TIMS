...
public class PhotoLookListActivity extends BaseActivity implements Observer{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mviCreateMessage:
                Intent intent = new Intent(PhotoLookListActivity.this, CreatImgActivity.class);
    ...
    public void initWidget() {
        userModel = (UserModel) this.getIntent().getSerializableExtra("msg");
    ...
    public void initData() {
        ...
        idphoto_gridView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(PhotoLookListActivity.this, ShowPictureActivity.class);
    ...
    private void listPhoneTypeMessage(boolean isShow) {
        ...
        params.put("imgUserId", userModel.getUid()+"");
    ...
    protected void callBackAllFailure(String strMsg, int actionId) {
        ...
        ToastUtil.show(PhotoLookListActivity.this, strMsg);
