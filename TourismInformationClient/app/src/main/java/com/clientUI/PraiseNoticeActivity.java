...
public class PraiseNoticeActivity extends BaseActivity {
	...
	private List<PraiseModel> list_result = new ArrayList<PraiseModel>();
	...
	private void MessageAction(boolean isShow) {
		...
		params.put("action_flag", "listPraiseNotice");
	...
	PraiseAdapter orderListAdapter;
	@Override
			...
			case Consts.actionId.resultFlag:
				if (null != entry.getData() && !TextUtils.isEmpty(entry.getData())) {
					...
					if (null != jsonMsg && !TextUtils.isEmpty(jsonMsg)) {
						list_result = mGson.fromJson(entry.getData(), new TypeToken<List<PraiseModel>>() {
						}.getType());
						orderListAdapter = new PraiseAdapter(PraiseNoticeActivity.this, list_result);
