...
public class ApplyCourseMessageActivity extends BaseActivity {
    // title
    ...
    private ApplyCourseModel courseModel;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.mIvBack:
                ApplyCourseMessageActivity.this.finish();
                break;
            case R.id.mIvStu:
                break;
            case R.id.mbtnPay:
    ...
    public void initData() {
        ...
        courseModel = (ApplyCourseModel) this.getIntent().getSerializableExtra("msg");
